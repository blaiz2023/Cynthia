...
# Download
Download the 32 bit Microsoft Windows binary <a href="src/cynthia.exe">cynthia.exe</a> - Windows All - or from the "<a href="bin/">bin</a>" or "<a href="src/">src</a>" folder(s) above.
